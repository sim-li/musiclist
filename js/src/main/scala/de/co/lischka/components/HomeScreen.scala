package de.co.lischka.components

import sri.macros.{OptDefault => NoValue, OptionalParam => U}
import de.co.lischka.components.ScreenWithParams.Params
...
class HomeScreen extends NavigationScreenComponentNoPS {
  ...
  def render() = {
    ...
    def goToSecondTitle = navigation.navigate[ScreenWithParams](new Params {
        override val title: String = "My cool second title"
    })

    View(style = styles.container)(
      getBlock(() => goToSecondTitle, "Screen With Params"),
